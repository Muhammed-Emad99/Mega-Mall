@if(Auth::user()->hasRole(['super-admin','admin']))
    ...
    @section('section-header')
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item">Update Product Details</div>
        </div>
    ...
    @section('section-body')
        ...
        <p class="section-lead">
            On this page you can update a <strong>product</strong>.
        </p>
                        ...
                        <form method="post" action="{{ route('admin.products.update' ,$product->id) }}"
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="row justify-content-md-between">
                                    <div class="col-12 col-md-3 mb-4 mb-md-0">
                                        <div class="image-preview w-100"
                                            ...
                                            <input type="file" name="images[]"
                                                   value="{{old('images',$product->images)}}" id="multiplefileupload"
                                                   tabindex="10"
                                                   accept="*/*" multiple/>
                                        </div>
                                        @error('images')
                                    ...
                                    <div class="col-12 col-md-9">
                                        <div
                                            class="image-preview h-auto"
                                            style="@error('images') border-color: #dc3545; @enderror"
                                            id="imagePreview">
                                            @foreach($product->images as $image)
                                                <div class="upload-place" id="upload-place">
                                                    <img class="img-shadow rounded preview-image" src="{{ File::exists('uploads/products/' . $product->slug . '/'.$image->name) &&
                                                                $image->name != null ? asset('uploads/products/' . $product->slug . '/'.$image->name)
                                                                   : asset('assets/img/avatar/avatar-1.png') }}">
                                                    <button class="remove-button" id="remove-button" type="button"><i
                                                            class="fa fa-times"></i>
                                                    </button>
                                                </div>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text"
                                       ...
                                       value="{{ old('discountPercentage',$product->discountPercentage) }}">
                                ...
                                <div class="selectgroup w-100">
                                    <label class="selectgroup-item">
                                        <input type="radio" name="featured"
                                               value="1"
                                               @checked($product->featured == 1) class="selectgroup-input w-100 h-100">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <select class="form-select select2" id="multiple-select-field"
                                    ...
                                    @foreach($categories as $category)
                                        <option
                                            value="{{ $category->id }}" {{ in_array($category->id, old('selectedCategories', [])) ? 'selected' : '' }} @foreach($product->categories as $selectedCategory)
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(document).on('click', '#remove-button', function () {
                ...
                $(this).parent('#upload-place').remove();
            });
        ...
        $('#multiplefileupload').on('change', function (e) {
            ...
            for (var i = 0; i < files.length; i++) {
                ...
                reader.onload = function (e) {
                    var uploadPlace = $('<div id="upload-place">').addClass('upload-place');
                    var image = $('<img>').attr('src', e.target.result).addClass('preview-image');
                    var removeButton = $('<button id="remove-button">').addClass('remove-button');
